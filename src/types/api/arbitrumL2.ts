...
export type ArbitrumL2MessageStatus =
  | 'initiated'
  | 'sent'
  | 'confirmed'
  | 'relayed'
...
export type ArbitrumL2TxnBatchDataAvailability =
  | ArbitrumL2TxnBatchDAAnytrust
  | ArbitrumL2TxnBatchDACelestia
  | {
      batch_data_container: Exclude<
        BatchDataContainer,
        'in_anytrust' | 'in_celestia'
      >
    }
